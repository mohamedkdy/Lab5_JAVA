...
import java.util.*;
	...
	із найбільшою кількістю символів записується останнім.
 	 */
public class MainCollectionsIO {

    static String firstFilePath = "C://Users//Mohamed//Desktop//input.txt";
    static String secondFilePath = "C://Users//Mohamed//Desktop//output.txt";
